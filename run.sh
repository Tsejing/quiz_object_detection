...
# 定义各目录
output_dir=/home/tf/tensorflow/quiz_object_detection/quiz-w8-data/out  # 训练目录
dataset_dir=/home/tf/tensorflow/quiz_object_detection/quiz-w8-data # 数据集目录，这里是写死的，记得修改
